<template>
  <li
    ...
    class="text-sm font-semibold text-white rounded-lg cursor-pointer hover:bg-gray-700"
  >
...
<script setup>
  ...
  import ImageMultipe from 'vue-material-design-icons/ImageMultiple.vue';
  ...
  if (iconString.value === 'Library') icon = ImageMultipe;
